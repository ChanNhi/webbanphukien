<?php
if(isset($_SESSION['cart']) && isset($_SESSION['dangnhap']) && isset($_SESSION['dathang'])){
    $tongtien=0;
    $tongsp=0;
    $i=0;
    $soluong = 0;
    $thanhtoan = 0;
    $thanhtien = 0;
    $sql_donhang = "SELECT * FROM donhang WHERE id = ".$_GET['iddonhang']."";
...
<div class="payment shadow p-3 mb-5 bg-body rounded">
    <div class="container">
        ...
        <table class="payment-sanpham">
            ...
            <?php
                $sql_donhang_ct = "SELECT * FROM donhang_chitiet WHERE id_donhang = ".$_GET['iddonhang']."";
